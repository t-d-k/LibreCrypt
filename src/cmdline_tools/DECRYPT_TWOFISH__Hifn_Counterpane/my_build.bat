...
cl -I..\..\..\3rd_party\libtomcrypt\crypt-1.17\src\headers -I..\..\..\3rd_party\Twofish\twofish-optimized-c /Fe..\DECRYPT_TWOFISH__Hifn_Counterpane.exe main.c rmd160.c TWOFISH2.C
cd ..
