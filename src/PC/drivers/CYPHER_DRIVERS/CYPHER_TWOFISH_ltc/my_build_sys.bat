...
rem Implementation...
copy ..\..\..\..\..\Common\CYPHER_DRIVERS\CYPHER_TWOFISH_ltc\* .

rem libtomcrypt library...
copy ..\..\..\..\..\3rd_party\libtomcrypt\crypt-1.17\src\ciphers\twofish\twofish.c .
copy ..\..\..\..\..\3rd_party\libtomcrypt\crypt-1.17\src\ciphers\twofish\twofish_tab.c .
