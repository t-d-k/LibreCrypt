...
rem Implementation...
copy ..\..\..\..\..\Common\CYPHER_DRIVERS\CYPHER_RC6_Gladman\* .
...
rem Gladman source...
copy ..\..\..\..\..\3rd_party\AES_candidates_2nd_round_-_Gladman\aes.r2.algs\rc6.c .

echo Building SYS...
build -cgZ

rem Copying the binary over...
copy %FREEOTFE_OUTPUT_DIR%\FreeOTFECypherRC6_Gladman.sys %BIN_OUTPUT_DIR%
