...
uses
  ...
  FreeOTFEExplorerfmeOptions_Base, FreeOTFEExplorerSettings, Graphics, Messages,
  SDUStdCtrls, Spin64,
...
procedure TfmeOptions_FreeOTFEExplorerGeneral.ckStoreLayoutClick(Sender: TObject);
begin
  inherited;
