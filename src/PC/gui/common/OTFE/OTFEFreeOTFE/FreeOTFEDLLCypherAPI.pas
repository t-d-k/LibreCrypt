...
//                                );
const DLLEXPORT_CYPHER_IDENTIFYDRIVER = 'CypherIdentifyDriver';
type PCypherDLLFnIdentifyDriver = function(
  Buffer: PDIOC_CYPHER_IDENTIFYDRIVER
): DWORD; cdecl;
...
//                                );
const DLLEXPORT_CYPHER_IDENTIFYSUPPORTED_v1 = 'CypherIdentifySupported';
type PCypherDLLFnIdentifySupported_v1 = function(
  BufferSize: integer;  // In bytes
  Buffer: PDIOC_CYPHER_IDENTIFYSUPPORTED_v1
): DWORD; cdecl;
...
//                                );
const DLLEXPORT_CYPHER_IDENTIFYSUPPORTED_v3 = 'CypherIdentifySupported_v3';
type PCypherDLLFnIdentifySupported_v3 = function(
  BufferSize: integer;  // In bytes
  Buffer: PDIOC_CYPHER_IDENTIFYSUPPORTED_v3
): DWORD; cdecl;
...
//                                 CYPHER_v1*
//                                );
const DLLEXPORT_CYPHER_GETCYPHERDETAILS_v1 = 'CypherGetCypherDetails';
type PCypherDLLFnGetCypherDetails_v1 = function(
  CypherGUID: PGUID;
...
//                                 CYPHER_v3*
//                                );
const DLLEXPORT_CYPHER_GETCYPHERDETAILS_v3 = 'CypherGetCypherDetails_v3';
type PCypherDLLFnGetCypherDetails_v3 = function(
  CypherGUID: PGUID;
...
//                         );
const DLLEXPORT_CYPHER_ENCRYPT = 'CypherEncrypt';
type PCypherDLLFnEncrypt = function(
  BufferInLen: DWORD;
  BufferIn: PDIOC_CYPHER_DATA_IN;
  BufferOutLen: DWORD;
  BufferOut: PDIOC_CYPHER_DATA_OUT
): DWORD; cdecl;
...
//                            DIOC_CYPHER_DATA_OUT*
//                         );
const DLLEXPORT_CYPHER_ENCRYPTSECTOR = 'CypherEncryptSector';
type PCypherDLLFnEncryptSector = function(
  BufferInLen: DWORD;
  BufferIn: PDIOC_CYPHER_SECTOR_DATA_IN;
  BufferOutLen: DWORD;
  BufferOut: PDIOC_CYPHER_DATA_OUT
): DWORD; cdecl;
...
//                            OUT     FREEOTFEBYTE*
//                         );
const DLLEXPORT_CYPHER_ENCRYPTWITHASCII = 'CypherEncryptWithASCII';
type PCypherDLLFnEncryptWithASCII = function(
  CypherGUID: PGUID;
  KeyLength: integer;  // In bits
  Key: PByte;
  KeyASCII: PChar;  // ASCII representation of "Key"
  IVLength: integer;  // In bits
  IV: PByte;
  PlaintextLength: integer;  // In bytes
  PlaintextData: PByte;
  CyphertextData: PByte
): DWORD; cdecl;
...
//                            OUT     FREEOTFEBYTE*
//                         );
const DLLEXPORT_CYPHER_ENCRYPTSECTORWITHASCII = 'CypherEncryptSectorWithASCII';
type PCypherDLLFnEncryptSectorWithASCII = function(
  CypherGUID: PGUID;
...
//                            DIOC_CYPHER_DATA_OUT*
//                         );
const DLLEXPORT_CYPHER_DECRYPT = 'CypherDecrypt';
type PCypherDLLFnDecrypt = function(
  BufferInLen: DWORD;
  BufferIn: PDIOC_CYPHER_DATA_IN;
  BufferOutLen: DWORD;
  BufferOut: PDIOC_CYPHER_DATA_OUT
...
//                            DIOC_CYPHER_DATA_OUT*
//                         );
const DLLEXPORT_CYPHER_DECRYPTSECTOR = 'CypherDecryptSector';
type PCypherDLLFnDecryptSector = function(
  BufferInLen: DWORD;
  BufferIn: PDIOC_CYPHER_SECTOR_DATA_IN;
  BufferOutLen: DWORD;
  BufferOut: PDIOC_CYPHER_DATA_OUT
...
//                            OUT     FREEOTFEBYTE*
//                         );
const DLLEXPORT_CYPHER_DECRYPTWITHASCII = 'CypherDecryptWithASCII';
type PCypherDLLFnDecryptWithASCII = function(
  CypherGUID: PGUID;
  KeyLength: integer;  // In bits
  Key: PByte;
  KeyASCII: PChar;  // ASCII representation of "Key"
  IVLength: integer;  // In bits
  IV: PByte;
  CyphertextLength: integer;  // In bytes
  CyphertextData: PByte;
  PlaintextData: PByte
): DWORD; cdecl;
...
//                            OUT     FREEOTFEBYTE*
//                         );
const DLLEXPORT_CYPHER_DECRYPTSECTORWITHASCII = 'CypherDecryptSectorWithASCII';
type PCypherDLLFnDecryptSectorWithASCII = function(
  CypherGUID: PGUID;
  SectorID: LARGE_INTEGER;
  SectorSize: integer;
  KeyLength: integer;  // In bits
