...
// maxSize - Size of data to transfer, in *bytes*, not sectors
function TPartitionImageDLL.ReadConsecutiveSectors(startSectorID: uint64; sectors: TStream; maxSize: integer = -1): boolean;
begin
  // Short circuit...
  if (maxSize = 0) then
    begin
...
// maxSize - Size of data to transfer, in *bytes*, not sectors
function TPartitionImageDLL.WriteConsecutiveSectors(startSectorID: uint64; sectors: TStream; maxSize: integer = -1): boolean;
begin
  // Short circuit...
  if (maxSize = 0) then
    begin
