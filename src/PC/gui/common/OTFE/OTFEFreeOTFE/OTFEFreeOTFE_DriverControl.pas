...
begin
 ...
 // driverNames - Set to a TStringList object which will have the driver names
 //               *added* to it
function TOTFEFreeOTFEDriverControl.GetFreeOTFEDriversInState(serviceState: DWORD;
  var driverNames: TStringList): Boolean;
const
...
function TOTFEFreeOTFEDriverControl.DriverConfig(service: String;
...
begin
 ...
 // Returns: TRUE/FALSE on success/failure
function TOTFEFreeOTFEDriverControl.GetServiceAutoStart(service: String;
...
begin
 ...
 // Returns: TRUE/FALSE on success/failure
function TOTFEFreeOTFEDriverControl.SetServiceAutoStart(service: String;
...
function TOTFEFreeOTFEDriverControl.InstallSetAutoStartAndStartDriver(
...
function TOTFEFreeOTFEDriverControl.InstallDriverFile(driverFilename: String;
...
function TOTFEFreeOTFEDriverControl.SetDriverReg(service: String; Name: String;
...
begin
 ...
 // IF THIS FUNCTION IS CHANGED, THEN ALL OTHER GetDriverRegXXX(...) SHOULD
 // PROBABLY ALSO BE CHANGED TO MATCH
function TOTFEFreeOTFEDriverControl.GetDriverRegBoolean(service: String;
...
function TOTFEFreeOTFEDriverControl.IsDriverInstalled(service: String;
...
function TOTFEFreeOTFEDriverControl.IsDriverInstalledPortable(service: String;
