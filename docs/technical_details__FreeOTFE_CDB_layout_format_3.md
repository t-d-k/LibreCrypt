...
<TITLE>Technical Details: LibreCrypt Critical Data Block (CDB) Layout (CDB Format ID 3) </TITLE>
...
### Technical Details: LibreCrypt Critical Data Block (CDB) Layout (CDB Format ID 3)
