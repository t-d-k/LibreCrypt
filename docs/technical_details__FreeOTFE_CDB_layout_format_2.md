...
<TITLE>Technical Details: FreeOTFE Critical Data Block (CDB) Layout (CDB Format ID 2)</TITLE>
...
### Technical Details: FreeOTFE Critical Data Block (CDB) Layout (CDB Format ID 2)
