...
<UL>
  ...
  * Certain combined mobile phone/PDA devices have issues mounting volumes. See FAQ for details of the [specific models affected](FAQ.htm#cm).

</UL>
Both of the above issues are currently under investigation, and should be fixed in a later version

If you believe that you have found a bug in FreeOTFE, it would be
**very much appreciated** if you could get in touch and report it; please see the section on: [Fault/Bug Reporting](fault_reporting.htm)
